...
var MobileSwitch = function (_React$Component) {
  _inherits(MobileSwitch, _React$Component);

  function MobileSwitch(props) {
    _classCallCheck(this, MobileSwitch);

    var _this = _possibleConstructorReturn(this, (MobileSwitch.__proto__ || Object.getPrototypeOf(MobileSwitch)).call(this, props));

    _this.handleClick = function (onChange, checked) {
  ...
  _createClass(MobileSwitch, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          unCheckedBg = _props.unCheckedBg,
          checkedBg = _props.checkedBg,
          style = _props.style,
      ...
      return _react2.default.createElement(
        "span",
        {
          className: "mobile-switch " + (checked ? "mobile-switch-checked" : "") + " " + className,
          tabIndex: "0",
          onClick: function onClick() {
            return _this2.handleClick(onChange, checked);
          },
